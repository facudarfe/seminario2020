...
@section('contenido')
    ...
    <form action="{{route('temas.subir')}}" method="POST" id="formTemas">
        @csrf
        <div class="row">
            <div class="col-xl-8">
                <div class="form-row">
                ...
                <div class="form-row py-3 justify-content-end">
                    ...
                    <div class="col-xl-3 form-group">
                        <button type="submit" id="botonCarga" class="btn btn-block btn-success">Crear tema</button>
                    </div>
                </div>
            </div>
        </div>
...
@section('otros-scripts')
    ...
    <script src="{{asset('js/propuestas/temas/crear.js')}}"></script>
@endsection